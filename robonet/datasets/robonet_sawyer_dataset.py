...
from robonet.datasets.util.hdf5_sawyer_loader import load_data, default_loader_hparams  # using hdf5 sawyer loader instead of hdf5 loader
...
class SawyerDataset(BaseVideoDataset):
    ...
    def _init_dataset(self):
        ...
        # set output format
        output_format = [tf.uint8, tf.float32, tf.float32, tf.float32] #added float32 for finger sensor
